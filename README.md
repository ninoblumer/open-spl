...
python -m slm.tests.realtime_load --duration 10 --out output/quick

# Full run — 300 s per cell (default)
python -m slm.tests.realtime_load --out output/full
```
...
```bash
python -m slm.tests.realtime_load --loadouts K2 --blocksizes 256 512 \
